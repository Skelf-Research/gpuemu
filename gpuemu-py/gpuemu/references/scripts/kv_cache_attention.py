#!/usr/bin/env python3
"""Registered gpuemu reference for `kv_cache_attention` (fp64 oracle).
...
from gpuemu.references.ops import run, kv_cache_attention  # noqa: E402

if __name__ == "__main__":
    run(kv_cache_attention)
